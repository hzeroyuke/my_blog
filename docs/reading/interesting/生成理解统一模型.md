...
相对于AR方案的另一条路线，就是External Diffusion，外接一个Diffusion Model的方案，Qwen-Image，Blip-3o这些都是这么做的，主要是容易丢细节

![](asset/Pasted%20image%2020260102130247.png)


## 3. Unified Model

在单个Transformer架构中实现自回归和扩散的逻辑交互，也有一些工作再做

![](asset/Pasted%20image%2020260102130517.png)

面对上述方案的一些Weakness，现在社区的方案往往是，仍然是同一个Transformer，但是我们只共享Attention层，然后面对NLP任务和CV任务，采用不同的线性层，也就是Mot的方案

![](asset/Pasted%20image%2020260102130848.png)
